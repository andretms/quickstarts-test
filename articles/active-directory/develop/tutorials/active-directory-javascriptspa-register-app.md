---
title: Azure AD v2 JS SPA Guided Setup - Register | Microsoft Docs
...
# JavaScript Single Page Application (SPA) - Register an app and configure code sample

This tutorial demonstrates how to register a JavaScript Single Page Application (SPA) in Microsoft Application Registration Portal so you can an sign in personal, work and school accounts, get an access token, and call the Microsoft Graph API or other APIs that require access tokens from the Azure Active Directory v2 endpoint.
...
> 2.	Copy the value from `URL` to the clipboard:<br/> ![Project properties](./media/active-directory-javascriptspa-sign-in/vs-project-properties-screenshot.png)<br />
